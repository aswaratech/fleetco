// Service-schedule due/overdue classification for the web (ADR-0037 c7). A
// ServiceSchedule (apps/api maintenance aggregate) is a recurring maintenance
// interval for a vehicle, measured in ONE of three dimensions:
...
// layer — the Vehicle detail page requests `status=ACTIVE` — so this classifier
// is status-agnostic and stays a pure function of (schedule, reading, now).
