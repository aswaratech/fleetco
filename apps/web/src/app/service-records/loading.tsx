// List-page skeleton for /service-records. Rendered by Next.js's Suspense
// boundary while page.tsx's server-side fetch is in flight — most commonly on a
// filter / sort / pagination change. Matches the page layout (max-width, header,
// two-filter toolbar, table, pagination bar) so the transition is layout-stable.
// Mirrors apps/web/src/app/service-schedules/loading.tsx.
      ...
      <div className="mx-auto max-w-6xl space-y-6 px-8 py-8">
        ...
        <div className="flex flex-wrap items-end gap-3" aria-hidden="true">
          ...
          <div className="flex flex-col gap-1">
            ...
            <div className="bg-surface-muted h-9 w-72 animate-pulse rounded" />
          </div>
        </div>
        ...
        <p className="sr-only">Loading service history…</p>
      </div>
    </main>
  );
}
