    ...
    <div className="flex flex-wrap items-end gap-3" aria-busy={pending}>
      <div className="flex flex-col gap-1">
        ...
        <select
          ...
          className="border-border-strong focus-visible:border-border-focus focus-visible:ring-border-focus/50 h-9 w-44 rounded-md border bg-transparent px-3 py-1 text-sm shadow-xs outline-none transition-[color,box-shadow] focus-visible:ring-[length:var(--focus-ring-width)]"
          value={category ?? ""}
          onChange={(e) => {
