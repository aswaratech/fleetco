...
// anything else — typically API connectivity failures). Mirrors the
// Vehicles detail-page error boundary.
  ...
  return (
    <main className="bg-surface-canvas min-h-svh">
      <div className="mx-auto max-w-2xl space-y-4 px-8 py-16">
        <h1 className="text-text-primary text-xl font-semibold">Could not load driver.</h1>
