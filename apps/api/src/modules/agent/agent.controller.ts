...
import { AgentService, type AgentTranscript, type AgentTurnResult } from "./agent.service";
import {
...
// The AI chat agent's HTTP surface (ADR-0043 c4/c5/c7, ticket A5). Four
// routes: create / list conversations, read one transcript, and POST a turn
// (the synchronous request/response the c7 UI consumes — no streaming in v1).
//
